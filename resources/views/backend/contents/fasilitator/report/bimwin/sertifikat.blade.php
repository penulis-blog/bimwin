    ...
    <div class="page" style="background-image: url('{{ public_path('storage/' . $peserta->files_1) }}');">
        ...
        <table style="margin: 0 40px; width: 100%; border-collapse: collapse; border: none; margin-left:20%;">
            ...
            <tr>
                ...
                <td style="border: none;">:</td>
                <td style="border: none; font-size:18px;">
                    {{-- @if($peserta->kategori_sert != 459)
                        {{ ucwords(strtolower($peserta->kecamatan.', '.$peserta->kabupaten.', '.$peserta->provinsi)) }}
                    @else
                        {{ ucwords(strtolower($peserta->instansi)) }}
                    @endif --}}
                    {{ $peserta->instansi }}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 75%; border: none; vertical-align: top;">
                    ...
                    <div style="margin: 10px 0;">
                        <img src="{{ public_path('storage/'.$peserta->ttd) }}" style="width: 80px; height: 80px; margin:10px;">
                    </div>
