...
<div class="modal fade" id="tambahBimwin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_bimwin_peserta">
                    @csrf
                    <!-- Nav Tabs -->
...
<div class="modal fade" id="editBimwin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_edit_bimwin_peserta">
                    @csrf
                    <input type="hidden" class="form-control" name="e_publicid" id="e_publicid">
                    <input type="hidden" class="form-control" name="e_kegiatan_read" id="e_kegiatan_read">
                    <input type="hidden" class="form-control" name="e_angkatan_read" id="e_angkatan_read">
                    ...
                    <ul class="nav nav-tabs" id="wizardTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-administratif-tab" data-bs-toggle="tab" data-bs-target="#editadministratif" type="button" role="tab">Administratif</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-instansi-tab" data-bs-toggle="tab" data-bs-target="#editinstansi" type="button" role="tab">Instansi</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content border p-3 mt-2" id="wizardTabContent">
                        ...
                        <div class="tab-pane fade show active" id="editbiodata" role="tabpanel">
                            @php
                                $isReadonly = auth()->user()->id_roles != 1;
                            @endphp
                            
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label"><b>Kegiatan</b></label>
                                <div class="col-sm-9">
                                    <select class="form-select" name="e_keg_bimwin" id="e_keg_bimwin" onchange="eAngkatan(this.value)" {{ $isReadonly ? 'disabled' : '' }}>></select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label"><b>Angkatan</b></label>
                                <div class="col-sm-9">
                                    <select class="form-select" name="e_angkatan_bimwin" id="e_angkatan_bimwin" {{ $isReadonly ? 'disabled' : '' }}></select>
                                </div>
                            </div>
...
<div class="modal fade" id="detailBimwin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="laporanBimwin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="laporan_jadwalbimwin">
                    @csrf
                    <div class="mb-3 row">
...
<div class="modal fade" id="importBimwin" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
