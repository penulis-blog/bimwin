<div class="modal fade" id="tambahJadwalLain" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_jadwallainnya">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" name="_kategori" id="_kategori"></select>
                        </div>
                    </div>
...
<div class="modal fade" id="editJadwalLainnya" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_edit_jadwallainnya">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>Kategori Kegiatan</b></label>
                        <div class="col-sm-9">
                            <select class="form-select" name="e_kategori" id="e_kategori"></select>
                        </div>
                    </div>
...
<div class="modal fade" id="detailJadwalLainnya" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="laporanJadwalLainnya" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="laporan_jadwalbrus">
                    @csrf
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>Acara</b></label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="FormulirJadwalLainnya" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
/* ukuran kolom */
.table-permissions-form th,
.table-permissions-form td {
  padding: 6px;
  font-size: 13px;
  white-space: nowrap;
}

.table-permissions-form th:nth-child(1),
.table-permissions-form td:nth-child(1) {
  width: 40px;
}

.table-permissions-form th:nth-child(2),
.table-permissions-form td:nth-child(2) {
  width: 200px;
...
<div class="modal fade" id="FormConfig" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5">Permissions Form Input</h1>
            </div>

            <div class="modal-body menupermissions_form">
                <form method="post">
                    @csrf
                    <div class="table-scroll-form">
                        <table class="table table-striped text-center table-permissions-form">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th style="text-align: center !important;">Label Input</th>
                                    <th>Placeholder</th>
                                    <th>Type Input</th>
                                    <th>Name Input</th>
                                    <th>Event Input</th>
                                    <th>Select Default</th>
                                    <th>Tampilkan</th>
                                </tr>
                            </thead>
                            <tbody id="permission_data_form">
                            </tbody>
                        </table>
                    </div>
