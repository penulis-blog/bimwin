<div class="modal fade" id="tambahKabupaten" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_kabupaten">
                    @csrf
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>Provinsi</b></label>
                        <div class="col-sm-9">
                            <select class="form-select" name="id_prov" id="id_prov"></select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nm_kabu" id="nm_kabu">
                        </div>
                    </div>
...
<div class="modal fade" id="editKabupaten" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="form_edit_kabupaten">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>Provinsi</b></label>
                        <div class="col-sm-9">
                            <select class="form-select" name="e_id_prov" id="e_id_prov"></select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>Nama Kabupaten</b></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="e_nm_kabu" id="e_nm_kabu">
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><b>ID Kabupaten</b></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="e_id_kabu" id="e_id_kabu" maxlength="4">
                        </div>
                    </div>
...
<div class="modal fade" id="detailKabupaten" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label"><b>ID Kabupaten</b></label>
                    <div class="col-sm-9">
                        <p class="form-control-plaintext" id="d_id_kabu"></p>
                    </div>
                </div>
