<script type="text/javascript">
    ...
    $('#gol_bimwin').select2({
        ...
        dropdownParent: $('#tambahJejaring') // 🔥 INI KUNCI
    });
    ...
    $(document).ready(function () {
        $('#jejaringTable').DataTable({
            ...
            pageLength: 9,
            lengthChange: false, // Opsional: sembunyikan pilihan jumlah data
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                if (item.kategori != 453) continue; // brus
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_jejaring_peserta");
    ...
    Page.Batal = function()
    {
        $.ajax({
            type: 'GET',
            beforeSend: function() {
                $('#tambahJejaring').modal('hide');
                $('#detailJejaring').modal('hide');
                $('#editJejaring').modal('hide');
                $('#importJejaring').modal('hide');
                $('#Loader').modal('show');
            },
                ...
                success: function(response){
                    ...
                    if (validGolongan.includes(response.data.golongan)) {
                        ...
                        $('#e_gol_bimwin').select2({
                            ...
                            placeholder: 'Pilih',
                            minimumResultsForSearch: 0,
                            dropdownParent: $('#editJejaring') // 🔥 INI KUNCI
                        });
                    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const form = document.getElementById("form_edit_jejaring_peserta");
        if (!form) return;
        ...
        form.addEventListener("submit", function (e) {
            ...
            const fields = {
                e_publicid: { value: e_publicid, message: "Public ID wajib." },
                e_keg_bimwin: { value: e_keg_bimwin, message: "Kegiatan wajib.", skipIf: "Pilih" },
                e_angkatan_bimwin: { value: e_angkatan_bimwin, message: "Angkatan wajib.", skipIf: "Pilih" },
                e_nik_bimwin: { value: e_nik_bimwin, message: "NIK wajib." },
                e_nama_bimwin: { value: e_nama_bimwin, message: "Nama wajib." },
                e_tmp_bimwin: { value: e_tmp_bimwin, message: "Tempat lahir wajib." },
                e_tgl_bimwin: { value: e_tgl_bimwin, message: "Tanggal lahir wajib." },
                e_jk_bimwin: { value: e_jk_bimwin, message: "Jenis kelamin wajib.", skipIf: "Pilih" },
                e_domisili_bimwin: { value: e_domisili_bimwin, message: "Alamat wajib." },
                e_hp_bimwin: { value: e_hp_bimwin, message: "HP wajib." },
                e_email_bimwin: { value: e_email_bimwin, message: "Email wajib." },
                e_rek_bimwin: { value: e_rek_bimwin, message: "Rekening wajib." },
                e_nm_bimwin: { value: e_nm_bimwin, message: "Nama bank wajib." },
                e_npwp_bimwin: { value: e_npwp_bimwin, message: "NPWP wajib." },
                e_nip_bimwin: { value: e_nip_bimwin, message: "NIP wajib." },
                e_prov_bimwin: { value: e_prov_bimwin, message: "Provinsi wajib.", skipIf: "Pilih" },
                e_pegawai_bimwin: { value: e_pegawai_bimwin, message: "Kategori pegawai wajib.", skipIf: "Pilih" },
                e_jbtn_bimwin: { value: e_jbtn_bimwin, message: "Jabatan wajib." },
                e_gol_bimwin: { value: e_gol_bimwin, message: "Golongan wajib.", skipIf: "Pilih" },
                e_inst_bimwin: { value: e_inst_bimwin, message: "Instansi wajib." },
                e_kantor_bimwin: { value: e_kantor_bimwin, message: "Alamat kantor wajib." },
                token: { value: token, message: "Token wajib." }
            };

            for (const k in fields) {
                const { value, message, skipIf } = fields[k];
                if (!value || value === skipIf) {
            ...
            const modalEl = document.getElementById("editJejaring");
            ...
            modalEl.addEventListener("hidden.bs.modal", function handler() {
                ...
                .then(res => {
                    ...
                    if (res.message === 200) {
                        ...
                        if (res.message === 201) msg = "File photo tidak boleh kosong.";
                        if (res.message === 202) msg = "Ukuran maksimal 3 MB.";
                        if (res.message === 203) msg = "Format file tidak valid.";
                        if (res.message === 404) msg = "Tidak bisa diperbaharui jika beda kegiatan, NIK dan NIP.";
                ...
                .catch(() => {
                    ...
                    Swal.fire("Error", "Kesalahan server.", "error")
                        .then(() => new bootstrap.Modal(modalEl).show());
                });
            });
