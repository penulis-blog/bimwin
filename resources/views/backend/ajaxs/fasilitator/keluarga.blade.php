<script type="text/javascript">
    ...
    $('#gol_bimwin').select2({
        ...
        dropdownParent: $('#tambahKeluarga') // 🔥 INI KUNCI
    });
    ...
    $(document).ready(function () {
        $('#KeluargaTable').DataTable({
            ...
            pageLength: 9,      // Default 9 data per halaman
            ...
            serverSide: true,
            deferRender: true,
            ajax: "{{ route('keluargapeserta.table') }}",
            columns: [
                { data: "DT_RowIndex" },
                { data: "judul_acara" },
    ...
    // Ambil Kegiatan Pendampingan Keluarga
    $.ajax({
        ...
        success: function(response) {
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                if (item.kategori != 454) continue; // pendampingan keluarga
    ...
    Page.Batal = function()
    {
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('#detailKeluarga').modal('hide');
                $('#editKeluarga').modal('hide');
                $('#importKeluarga').modal('hide');
                $('#Loader').modal('show');
            },
                ...
                success: function(response){
                    ...
                    if (validGolongan.includes(response.data.golongan)) {
                        ...
                        $('#e_gol_bimwin').select2({
                            ...
                            placeholder: 'Pilih',
                            minimumResultsForSearch: 0,
                            dropdownParent: $('#editKeluarga') // 🔥 INI KUNCI
                        });
                    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", function (e) {
            ...
            const modalEl = document.getElementById("editKeluarga");
