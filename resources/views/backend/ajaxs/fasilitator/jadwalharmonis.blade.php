<script type="text/javascript">
    ...
    $('#l_kategori').select2({
        ...
        dropdownParent: $('#laporanJadwalHarmonis') // 🔥 INI KUNCI
    });

    // JSON Datatables
    $(document).ready(function () {
        $('#jadwalharmonisTable').DataTable({
        fixedColumns: {
            left: 1,
            right: 1
        },
        ...
        buttons: [
            ...
            action: function ( e, dt, node, config ) {
                var tambah = {{ get_add() }};
                if(tambah == 1){
                    $('#tambahJadwalHarmonis').modal('show');
                }else if(tambah == 0){
                    Swal.fire({
                        title: "Informasi",
            ...
            action: function ( e, dt, node, config ) {
                ...
                if(laporan == 1){
                    $('#laporanJadwalHarmonis').modal('show');
                }else if(laporan == 0){
                    Swal.fire({
                        title: "Informasi",
        ...
        'serverSide': true,
        'deferRender': true,
        "ajax": "{{ route('jadwalharmonis.table') }}",
        "columns": [
            {"data":"DT_RowIndex"},
            {"data":"judul_acara"},
            {"data":"tempat"},
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $('#tempt').select2({
                ...
                placeholder: 'Pilih',
                minimumResultsForSearch: 0,
                dropdownParent: $('#tambahJadwalHarmonis') // 🔥 INI KUNCI
            });
        }
    });
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("laporan_jadwaljejaring");
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                hideModal("laporanJadwalHarmonis");
                ...
                setTimeout(async () => {
                    ...
                    try {
                        ...
                        if (
                            ...
                            a.href = url;
                            a.download = "laporan-jejaring.xlsx";
                            ...
                            if (result.message === 201) {
                                ...
                                showModal("laporanJadwalHarmonis");
    ...
    // Input Data
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_jadwaljejaring");
            ...
            try {
                hideModal("tambahJadwalHarmonis");
                ...
                if (result.message === 200) {
                    ...
                    showModal("tambahJadwalHarmonis");
                } else {
    ...
    Page.Batal = function()
    {
        $.ajax({
            type: 'GET',
            beforeSend: function() {
                $('#tambahJadwalHarmonis').modal('hide');
                $('#detailJadwalHarmonis').modal('hide');
                $('#editJadwalHarmonis').modal('hide');
                $('#FormulirJadwalHarmonis').modal('hide');
                $('#laporanJadwalHarmonis').modal('hide');
                $('#Loader').modal('show');
            },
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#e_status').select2({
                        ...
                        placeholder: 'Pilih',
                        minimumResultsForSearch: 0,
                        dropdownParent: $('#editJadwalHarmonis')
                    });
                }
            });
        }
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('#ed_direktorat').select2({
                    ...
                    placeholder: 'Pilih',
                    minimumResultsForSearch: 0,
                    dropdownParent: $('#editJadwalHarmonis') // 🔥 INI KUNCI
                });
            }
        });
    }
    ...
    // Edit Data
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_edit_jadwaljejaring");
        ...
        if(val == '' || val == null || val == 0){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#detailJadwalHarmonis').modal('show');
    ...
    Page.Back = function(val) {
        ...
        if (val == '' || val == null || val == 0) {
            let baseUrl = "{{ route('barcodejejaring.download', ':id') }}";
            let index = 1;
            ...
            $('#FormulirJadwalHarmonis').modal('show');
        } else {
            let baseUrl = "{{ route('barcodejejaring.download', ':id') }}";
            let index = 1;
