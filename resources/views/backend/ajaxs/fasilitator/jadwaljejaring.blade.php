<script type="text/javascript">
    ...
    $('#l_kategori').select2({
        ...
        dropdownParent: $('#laporanJadwalJejaring') // 🔥 INI KUNCI
    });

    // JSON Datatables
    $(document).ready(function () {
        $('#jadwaljejaringTable').DataTable({
        fixedColumns: {
            left: 1,
            right: 1
        },
        ...
        buttons: [
            ...
            action: function ( e, dt, node, config ) {
                var tambah = {{ get_add() }};
                if(tambah == 1){
                    $('#tambahJadwalJejaring').modal('show');
                }else if(tambah == 0){
                    Swal.fire({
                        title: "Informasi",
            ...
            action: function ( e, dt, node, config ) {
                ...
                if(laporan == 1){
                    $('#laporanJadwalJejaring').modal('show');
                }else if(laporan == 0){
                    Swal.fire({
                        title: "Informasi",
        ...
        'serverSide': true,
        'deferRender': true,
        "ajax": "{{ route('jadwaljejaring.table') }}",
        "columns": [
            {"data":"DT_RowIndex"},
            {"data":"judul_acara"},
            {"data":"tempat"},
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $('#tempt').select2({
                ...
                placeholder: 'Pilih',
                minimumResultsForSearch: 0,
                dropdownParent: $('#tambahJadwalJejaring') // 🔥 INI KUNCI
            });
        }
    });
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                hideModal("laporanJadwalJejaring");
                    ...
                    try {
                        ...
                        if (
                            ...
                            if (result.message === 201) {
                                ...
                                showModal("laporanJadwalJejaring");
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_jadwaljejaring");
            ...
            try {
                hideModal("tambahJadwalJejaring");
                ...
                if (result.message === 200) {
                    ...
                    showModal("tambahJadwalJejaring");
                } else {
    ...
    Page.Batal = function()
    {
        $.ajax({
            type: 'GET',
            beforeSend: function() {
                $('#tambahJadwalJejaring').modal('hide');
                $('#detailJadwalJejaring').modal('hide');
                $('#editJadwalJejaring').modal('hide');
                $('#FormulirJadwalJejaring').modal('hide');
                $('#laporanJadwalJejaring').modal('hide');
                $('#Loader').modal('show');
            },
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#e_status').select2({
                        ...
                        placeholder: 'Pilih',
                        minimumResultsForSearch: 0,
                        dropdownParent: $('#editJadwalJejaring')
                    });
                }
            });
        }
        ...
        if(val == '' || val == null || val == 0){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#detailJadwalJejaring').modal('show');
    ...
    Page.Back = function(val) {
        ...
        if (val == '' || val == null || val == 0) {
            ...
            $('#FormulirJadwalJejaring').modal('show');
        } else {
            let baseUrl = "{{ route('barcodejejaring.download', ':id') }}";
            let index = 1;
