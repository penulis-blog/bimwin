<script type="text/javascript">
    ...
    $('#l_kategori').select2({
        ...
        dropdownParent: $('#laporanJadwalLiterasi') // 🔥 INI KUNCI
    });

    // JSON Datatables
    $(document).ready(function () {
        $('#jadwalliterasiTable').DataTable({
        fixedColumns: {
            left: 1,
            right: 1
        },
        ...
        buttons: [
            ...
            action: function ( e, dt, node, config ) {
                var tambah = {{ get_add() }};
                if(tambah == 1){
                    $('#tambahJadwalLiterasi').modal('show');
                }else if(tambah == 0){
                    Swal.fire({
                        title: "Informasi",
            ...
            action: function ( e, dt, node, config ) {
                ...
                if(laporan == 1){
                    $('#laporanJadwalLiterasi').modal('show');
                }else if(laporan == 0){
                    Swal.fire({
                        title: "Informasi",
        ...
        'serverSide': true,
        'deferRender': true,
        "ajax": "{{ route('literasijadwal.table') }}",
        "columns": [
            {"data":"DT_RowIndex"},
            {"data":"judul_acara"},
            {"data":"tempat"},
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("laporan_jadwalliterasi");
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                hideModal("laporanJadwalLiterasi");
                ...
                setTimeout(async () => {
                    ...
                    try {
                        ...
                        if (
                            ...
                            a.href = url;
                            a.download = "laporan-literasi.xlsx";
                            ...
                            if (result.message === 201) {
                                ...
                                showModal("laporanJadwalLiterasi");
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#_direktorat').select2({
                    ...
                    placeholder: 'Pilih',
                    minimumResultsForSearch: 0,
                    dropdownParent: $('#tambahJadwalLiterasi') // 🔥 INI KUNCI
                });
            }
        });
    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_jadwalbimwin");
            ...
            try {
                hideModal("tambahJadwalLiterasi");
                ...
                if (result.message === 200) {
                    ...
                    showModal("tambahJadwalLiterasi");
                } else {
