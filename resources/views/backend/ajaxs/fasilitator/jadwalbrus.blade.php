<script type="text/javascript">
    ...
    $('#l_kategori').select2({
        ...
        dropdownParent: $('#laporanJadwalBrus') // 🔥 INI KUNCI
    });

    // JSON Datatables
    $(document).ready(function () {
        $('#jadwalbrusTable').DataTable({
        fixedColumns: {
            left: 1,
            right: 1
        },
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $('#tempt').select2({
                ...
                placeholder: 'Pilih',
                minimumResultsForSearch: 0,
                dropdownParent: $('#tambahJadwalBrus') // 🔥 INI KUNCI
            });
        }
    });
    ...
    // Input Data
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_jadwalbrus");
    ...
    Page.Batal = function()
    {
        $.ajax({
            type: 'GET',
            beforeSend: function() {
                $('#tambahJadwalBrus').modal('hide');
                $('#detailJadwalBrus').modal('hide');
                $('#editJadwalBrus').modal('hide');
                $('#FormulirJadwalBrus').modal('hide');
                $('#laporanJadwalBrus').modal('hide');
                $('#Loader').modal('show');
            },
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('#ed_direktorat').select2({
                    ...
                    placeholder: 'Pilih',
                    minimumResultsForSearch: 0,
                    dropdownParent: $('#editJadwalBrus') // 🔥 INI KUNCI
                });
            }
        });
    }
    ...
    // Edit Data
    document.addEventListener("DOMContentLoaded", () => {
        const form = document.getElementById("form_edit_jadwalbrus");
