    ...
    <table style="border-collapse: collapse; width: 100%; vertical-align: middle;">
        ...
        @foreach($data as $item)
            <tr style="font-size: 15px;">
                ...
                <td style="border:1px solid black; text-align:center; vertical-align: middle;">{{ "'" . strtoupper($item->no_rek ?? '-') }}</td>
                <td style="border:1px solid black; text-align:center; vertical-align: middle;">{{ strtoupper($item->nm_bank ?? '-') }}</td>
