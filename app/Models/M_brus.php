...
class M_bimwin extends Model
{
    ...
    {
        $data = DB::table('dt_kegiatan')->select('id', 'id_direktorat', 'id_subdit', 'judul_acara', 'tempat', 'lokasi', 'judul_form', 'angkatan', 'created', 'is_trash')->get();
        return $data;
    }
    ...
    {
        return DB::table('mst_template_materi')->select('judul', 'total')->where([['id_template', '=', $id], ['is_trash', '=', '99']])->get();
    }
