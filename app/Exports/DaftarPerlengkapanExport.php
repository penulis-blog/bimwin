...
class DaftarPerlengkapanExport implements WithMultipleSheets
{
    protected $data;
    protected $single;
    protected $tanggal;
    ...
    public function sheets(): array
    {
        ...
        if ($angkatanList->isEmpty()) {
            ...
            $sheets[] = new DaftarPerlengkapanPerAngkatanSheet($this->data, $this->single, $this->tanggal, 'Semua Peserta');
        } else {
            foreach ($angkatanList as $angkatan) {
                ...
                $sheets[] = new DaftarHadirPerAngkatanSheet($filtered, $this->single, $this->tanggal, $label);
            }
        }
